...
* The last part of readme [Travis and Google Container Registry](#Travis-and-Google-Container-Registry) is not a task in the exam and can be skipped. It's an extension to task 1.
